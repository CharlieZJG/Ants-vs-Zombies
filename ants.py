...
class HungryAnt(Ant):
    ...
    name = 'Hungry'
    # OVERRIDE CLASS ATTRIBUTES HERE
    # BEGIN Problem 6time_to_digest = 3
    time_to_digest = 3
    food_cost = 4
    armor = 1
    implemented = False   # Change to True to view in the GUI
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.impostor:
            ...
            while curr != None:
                if curr.ant and curr.ant not in self.doubled_ant:
                    curr.ant.damage = 2 * curr.ant.damage
                    self.doubled_ant.append(curr.ant)
                if isinstance(curr.ant,BodyguardAnt) and curr.ant.contained_ant and curr.ant.contained_ant not in self.doubled_ant:
                    curr.ant.contained_ant.damage = 2 * curr.ant.contained_ant.damage
                    self.doubled_ant.append(curr.ant.contained_ant)
                curr = curr.exit
